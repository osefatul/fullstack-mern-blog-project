...
- We have created first multiple pages, as each page is composed of react component
  - #### Home: This page is the home page of the blog. here you will be able to see all posts and menue.
  - #### Write: This page will be used in order to write a post.
  - #### Login: Login page is used to login if you already registered.
  - #### Register: This page is used to register.
  - #### Settings: This page is used to update settings as you want.
